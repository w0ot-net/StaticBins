...
`artifacts/x86/ltrace` only after validation.
...
Validation requires the ELF32 little-endian i686/SSE2 and static-PIE
invariants, complete final-link evidence, the exact version, and a direct-child
trace of `puts` in a dynamically linked musl executable inside a pinned x86
