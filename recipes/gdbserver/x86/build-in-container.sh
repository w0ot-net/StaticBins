...
CXXFLAGS="-O2 -pipe -march=i686 -msse2 -mfpmath=sse" \
...
if ! file /out/gdbserver | grep -Eq 'ELF 32-bit LSB executable, Intel (i386|80386)'; then
    echo "error: GDBserver is not a 32-bit little-endian x86 executable" >&2
    exit 1
fi
