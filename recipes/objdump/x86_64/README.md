# Static GNU objdump 2.47 for x86-64

From the repository root, run:

```sh
./build.sh objdump x86_64
```
...
immutable x86-64 builder lock, then replaces `artifacts/x86_64/objdump` only
after validation.
...
symbols, and real disassembly of a controlled x86-64 relocatable object.
