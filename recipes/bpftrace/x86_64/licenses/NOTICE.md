...
`artifacts/x86_64/bpftrace` is built from the exact archive recorded in
...
`ghcr.io/w0ot-net/static_bins-builder@sha256:4792e2ede5fcedfa0b28440287316e609e5686921762fb6d24c2f5e056380752`.
