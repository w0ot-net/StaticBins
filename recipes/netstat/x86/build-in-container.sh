...
target_cflags="-O2 -pipe -march=i686 -msse2 -mfpmath=sse"
...
if ! grep -Fq -- '-march=i686 -msse2 -mfpmath=sse' /out/netstat-build.log; then
    echo "error: x86 build log does not contain the required i686/SSE2 baseline" >&2
    exit 1
fi
