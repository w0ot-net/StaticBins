# Static netstat 2.10 for ARMv7

From the repository root, run:

```sh
./build.sh netstat armv7
```

The command requires Bash, Docker, Docker Buildx, `file`, `readelf`, and
`sha256sum`. It consumes the immutable ARMv7 builder in
`builders/armv7/environment.lock` and replaces `artifacts/armv7/netstat`
